...
exports.fallback = function (codec) { return function (a, name) {
    ...
    return withValidate_1.withValidate(codec, function (u, c) { return Either_1.orElse(function (e) { return (isFallbackValid ? t.success(a) : Either_1.left(e)); })(codec.validate(u, c)); }, name);
}; };
