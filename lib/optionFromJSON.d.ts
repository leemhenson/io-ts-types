...
export interface OptionFromJSONC<C extends t.Mixed> extends t.Type<Option<t.TypeOf<C>>, Option<t.OutputOf<C>>, unknown> {
}
/**
 ...
 * @since 0.4.4
 */
export declare function optionFromJSON<C extends t.Mixed>(codec: C, name?: string): OptionFromJSONC<C>;
