 ...
 * ```
 */
export declare const fromNewtype: <N extends AnyNewtype = never>(codec: Type<CarrierOf<N>, CarrierOf<N>, unknown>) => Type<N, CarrierOf<N>, unknown>;
export declare const fromNewtypeCurried: <N extends AnyNewtype = never>() => <O>(codec: Type<CarrierOf<N>, O, unknown>) => Type<N, O, unknown>;
