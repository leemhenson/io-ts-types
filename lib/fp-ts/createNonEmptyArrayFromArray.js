...
exports.createNonEmptyArrayFromArray = function (codec, name) {
    ...
    return new NonEmptyArrayFromArrayType(name, function (m) { return ArrayType.is(m) && m.length > 0; }, function (m, c) {
        return Either_1.either.chain(ArrayType.validate(m, c), function (as) {
            return Option_1.fold(function () { return t.failure(as, c); }, t.success)(NonEmptyArray_1.fromArray(as));
        });
    }, function (a) { return ArrayType.encode(a); }, codec);
};
